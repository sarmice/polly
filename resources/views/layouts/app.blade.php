...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="{{ route('polls.index') }}">PollApp</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('polls.index') }}">Home</a>
                </li>
                <li class="nav-item">
        ...
        @if (auth()->check())
            <a href="{{ route('polls.index') }}">My Polls</a>
            <!-- Link to log out -->
